...
{
    public class TreeVisitor : DateCalculatorBaseVisitor<System.DateTime>
    {
        ...
        public override System.DateTime VisitTimespan([NotNull]DateCalculatorParser.TimespanContext context)
        {
        ...
        public override System.DateTime VisitTimespanAddTimespan([NotNull] DateCalculatorParser.TimespanAddTimespanContext context)
        {
            System.DateTime date1 = Visit(context.GetChild(0));
            System.DateTime date2 = Visit(context.GetChild(2));
